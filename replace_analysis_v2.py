...
# Find the Analysis section start - use the section tag with id
start_marker = '<section\n                    class="page-section"\n                    id="page-analysis"\n                    data-page-section="analysis"\n                >'
start = content.find(start_marker)

# Find the end - closing section before TRENDS PAGE
end_marker = '</section>\n\n                <!-- =========================================\n                     TRENDS PAGE'
...
if start != -1 and end != -1:
    ...
    with open('D:/aqua-ai/frontend/index.html', 'w', encoding='utf-8') as f:
        f.write(new_content)

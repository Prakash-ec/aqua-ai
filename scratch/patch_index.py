                ...
                >
                    ...
                    <article class="content-card">
                        <div class="content-card-header">
                            <div>
                                ...
                                <p>Detailed breakdown of sensor readings against analytical thresholds.</p>
                            </div>
                        </div>
                        <div id="analysisParameterAssessment" style="padding-top: 16px;"></div>
                    </article>
                    ...
                    <article class="content-card">
                        ...
                        <div class="an-tabs" role="tablist" aria-label="Application categories" style="margin-top: 16px;">
                            ...
                            <button class="an-tab" role="tab" aria-selected="false" data-an-tab="drinking" type="button">Drinking Screening</button>
                        ...
                        <div id="analysisKeyLimitingFactor" style="margin-top: 24px;"></div>

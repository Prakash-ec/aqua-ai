...
new_analysis_html = """                <section
                ...
                >
                    ...
                    <article class="content-card">
                        <div class="content-card-header">
                            <div>
                                ...
                                <p>Directly obtained from sensors.</p>
                            </div>
                        </div>
                    ...
                    <article class="content-card">
                        <div class="content-card-header">
                            <div>
                                ...
                                <p>Calculated from measured values.</p>
                            </div>
                        </div>
                    ...
                    <article class="content-card">
                        ...
                        <!-- Category Summary -->
                        <div id="analysisCategorySummary" style="padding-top: 16px;"></div>
                    ...
                    <article class="content-card">
                        <div class="content-card-header">
                            <div>
                                <span style="font-size: 11px; text-transform: uppercase; color: var(--text-muted); letter-spacing: 0.5px; font-weight: 600;">Analytical Score</span>
                                <h3>Drinking Screening</h3>
                                <p>Screening based only on the available sensor parameters.</p>
                            </div>
                        </div>
